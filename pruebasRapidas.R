...
dat2 <- read_table2("data/Tests/101/Testler Export/801-Yurume Ileri/Test_1/340527.txt", skip = 4)
dat2 <- as.data.frame(dat2)
dat2 <- dat2[c(-1,-2,-6:-9,-23,-24)]

dat3 <- read_table2("data/Tests/101/Testler Export/801-Yurume Ileri/Test_1/340535.txt", skip = 4)
dat3 <- as.data.frame(dat3)
dat3 <- dat3[c(-1,-2,-6:-9,-23,-24)]

dat4 <- read_table2("data/Tests/101/Testler Export/801-Yurume Ileri/Test_1/340537.txt", skip = 4)
dat4 <- as.data.frame(dat4)
dat4 <- dat4[c(-1,-2,-6:-9,-23,-24)]

dat5 <- read_table2("data/Tests/101/Testler Export/801-Yurume Ileri/Test_1/340539.txt", skip = 4)
dat5 <- as.data.frame(dat5)
dat5 <- dat5[c(-1,-2,-6:-9,-23,-24)]

dat6 <- read_table2("data/Tests/101/Testler Export/801-Yurume Ileri/Test_1/340540.txt", skip = 4)
