...
datF1 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_1/340506.txt", skip = 4)
datF1 <- as.data.frame(datF1)
datF1 <- datF1[c(-1,-2,-6:-9,-23,-24)]

datF2 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_2/340506.txt", skip = 4)
datF2 <- as.data.frame(datF2)
datF2 <- datF2[c(-1,-2,-6:-9,-23,-24)]

datF3 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_3/340506.txt", skip = 4)
datF3 <- as.data.frame(datF3)
datF3 <- datF3[c(-1,-2,-6:-9,-23,-24)]

datF4 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_4/340506.txt", skip = 4)
datF4 <- as.data.frame(datF4)
datF4 <- datF4[c(-1,-2,-6:-9,-23,-24)]

datF5 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_5/340506.txt", skip = 4)
datF5 <- as.data.frame(datF5)
datF5 <- datF5[c(-1,-2,-6:-9,-23,-24)]

#datF6 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_6/340506.txt", skip = 4)
...
datF1 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_1/340535.txt", skip = 4)
datF1 <- as.data.frame(datF1)
datF1 <- datF1[c(-1,-2,-6:-9,-23,-24)]

datF2 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_2/340535.txt", skip = 4)
datF2 <- as.data.frame(datF2)
datF2 <- datF2[c(-1,-2,-6:-9,-23,-24)]

datF3 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_3/340535.txt", skip = 4)
datF3 <- as.data.frame(datF3)
datF3 <- datF3[c(-1,-2,-6:-9,-23,-24)]

datF4 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_4/340535.txt", skip = 4)
datF4 <- as.data.frame(datF4)
datF4 <- datF4[c(-1,-2,-6:-9,-23,-24)]

datF5 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_5/340535.txt", skip = 4)
datF5 <- as.data.frame(datF5)
datF5 <- datF5[c(-1,-2,-6:-9,-23,-24)]

#datF6 <- read_table2("data/Tests/101/Testler Export/901-OneDogruUzanma/Test_6/340535.txt", skip = 4)
#datF6 <- as.data.frame(datF6)
#datF6 <- datF6[c(-1,-2,-6:-9,-23,-24)]
...
meanCabeza$gender <- 1 # 0 = female, 1 = male
meanCabeza$patient <- '101'
...
meanHeadF$gender <- 1 # 0 = female, 1 = male
meanHeadF$patient <- '101'
...
meanChest$gender <- 1 # 0 = female, 1 = male
meanChest$patient <- '101'
...
meanChestF$gender <- 1 # 0 = female, 1 = male
meanChestF$patient <- '101'
...
meanWaist$gender <- 1 # 0 = female, 1 = male
meanWaist$patient <- '101'
...
meanWaistF$gender <- 1 # 0 = female, 1 = male
meanWaistF$patient <- '101'
...
px101 <- rbind(meanCabeza, meanHeadF, meanChest, meanChestF, meanWaist, meanWaistF)